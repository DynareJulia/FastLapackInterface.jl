...
@testset "GeesWs" begin
    ...
    @testset "Real, square, select" begin
        ...
        A1, vs1, wr1 = FastLapackInterface.gees!((wr, wi) -> wi^2 + wr^2 >= 1, 'V',
                                                 copy(A0), ws1)
        @test ws1.sdim[] == 2
...
@testset "GgesWs" begin
    ...
    @testset "Real, square" begin
        ...
        A2, B2, eig2, β2, vsl2, vsr2 = FastLapackInterface.gges!('V', 'V', copy(A0),
                                                                 copy(B0), ws)
        @test isapprox(A1, A2)
        @test isapprox(B1, B2)
    ...
    @testset "Real, square, select" begin
        ...
        A0, B0, eig, β, vsl, vsr = FastLapackInterface.gges!((ar, ai, b) -> ar^2 + ai^2 <
